...
export function DailyQuoteCard({ quote, date }: { quote: MotivationQuote; date: string }) {
  return (
    <section aria-labelledby="daily-inspiration-heading" className="relative flex h-full min-h-80 min-w-0 flex-col justify-between overflow-hidden rounded-2xl bg-linear-to-br from-primary to-[#004b36] p-6 text-white shadow-soft md:min-h-96 md:p-8">
