    ...
    <Card className="p-4 md:p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-md border border-outline bg-surface-container-low px-2.5 py-2 text-sm font-medium text-secondary transition-colors hover:border-error/40 hover:text-error"
        >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <input
            ...
            className="min-h-14 min-w-0 w-full rounded-md border border-outline bg-surface-container-low px-4 text-base text-on-surface outline-none transition-colors placeholder:text-secondary focus:border-primary focus:ring-2 focus:ring-primary/20"
          />
