...
const Explore = () => {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Explore Exercises</h1>
        <p className="text-gray-600">Discover new exercises to add to your workout routine</p>
      </div>
      ...
      {exercises.length > 0 ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-600">Try a different search term or clear your search.</p>
        </div>
      )}
    </div>
  );
